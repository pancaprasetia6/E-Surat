...
if (isset($_GET['id_request_sku'])) {
    ...
    $qrCodePath = generateQRCode($signature, $id, 'sku');
    
    // Simpan signature ke database
    $data_json = json_encode($data_to_sign);
    $cek_db = mysqli_query($konek, "SELECT * FROM digital_signature_log WHERE id_request='$id' AND jenis_surat='sku'");
    if(mysqli_num_rows($cek_db) == 0) {
        mysqli_query($konek, "INSERT INTO digital_signature_log (id_request, jenis_surat, data_json, signature) VALUES ('$id', 'sku', '$data_json', '$signature')");
    }
    ...
    <div class="container">
        ...
        <div class="content">
            <center>
                ...
                <hr style="margin:5px 0; width: 33%;" color="black">
            ...
            <table style="margin-left: 50px;">
                ...
                <tr>
                    <td>Jenis Kelamin</td>
                    <td>:</td>
                    <td><?php echo ($jekel == 'L') ? 'Laki-laki' : 'Perempuan'; ?></td>
                </tr>
                <tr>
                    <td>Agama</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><?php echo $alamat . " RT " . $rt . " RW " . $rw; ?></td>
                </tr> 
            </table>
            <br>

            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan surat keterangan RT/RW setempat benar bahwa nama tersebut benar pada saat ini memiliki usaha sebagai berikut :</p>
            <br> 
            <table style="margin-left: 50px;">
                <tr>
            ...
            <br>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan usaha ini diberikan kepada yang bersangkutan untuk dapat dipergunakan sebagaimana mestinya.</p>
        </div>
