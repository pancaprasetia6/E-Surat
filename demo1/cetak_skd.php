...
if (isset($_GET['id_request_skd'])) {
    ...
    $qrCodePath = generateQRCode($signature, $id, 'skd');
    
    // Simpan signature ke database
    $data_json = json_encode($data_to_sign);
    $cek_db = mysqli_query($konek, "SELECT * FROM digital_signature_log WHERE id_request='$id' AND jenis_surat='skd'");
    if(mysqli_num_rows($cek_db) == 0) {
        mysqli_query($konek, "INSERT INTO digital_signature_log (id_request, jenis_surat, data_json, signature) VALUES ('$id', 'skd', '$data_json', '$signature')");
    }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <table style="margin-left: 50px;">
                ...
                <tr><td>Maksud/Keperluan</td><td>:</td><td>Menerangkan bahwa benar nama tersebut diatas adalah warga kami yang berlokasi di <?php echo $alamat . " RT " . $rt . " RW " . $rw; ?>, Surat domisili ini digunakan untuk  keperluan: <?php echo $keperluan; ?></td></tr>
            </table>
            <br>
