...
if(isset($_GET['id_request_skbm'])){
    ...
    $tampil_nik = "SELECT * FROM data_request_skbm WHERE id_request_skbm=$id";
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">UBAH DATA PENGAJUAN SKBM</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
...
if(isset($_POST['ubah'])){
    ...
    if($query){
        ...
        echo '<meta http-equiv="refresh" content="3; url=?halaman=ubah_skbm&id_request_skbm='.$id.'">';
    }
}
?>