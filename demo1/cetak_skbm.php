...
if (isset($_GET['id_request_skbm'])) {
    ...
    $qrCodePath = generateQRCode($signature, $id, 'skbm');
    
    // Simpan signature ke database
    $data_json = json_encode($data_to_sign);
    $cek_db = mysqli_query($konek, "SELECT * FROM digital_signature_log WHERE id_request='$id' AND jenis_surat='skbm'");
    if(mysqli_num_rows($cek_db) == 0) {
        mysqli_query($konek, "INSERT INTO digital_signature_log (id_request, jenis_surat, data_json, signature) VALUES ('$id', 'skbm', '$data_json', '$signature')");
    }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang tersebut diatas adalah benar-benar warga kami dengan status belum menikah. surat keterangan ini dibuat untuk keperluan <?php echo $keperluan; ?></p>
