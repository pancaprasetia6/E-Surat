...
if(isset($_GET['id_request_skd'])){
    ...
    $tampil_nik = "SELECT * FROM data_request_skd WHERE id_request_skd=$id";
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">UBAH PENGAJUAN SKD</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="keperluan" name="keperluan" rows="3" placeholder="Tuliskan keperluan pembuatan surat keterangan domisili" required><?= $keperluan; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
if(isset($_POST['ubah'])){
    ...
    if($query){
        ...
        echo '<meta http-equiv="refresh" content="3; url=?halaman=ubah_skd&id_request_skd='.$id.'">';
    }
}
?>