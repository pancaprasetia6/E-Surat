			...
			<form method="POST" enctype="multipart/form-data">
				<div class="card">
					<div class="card-header">
						<div class="card-title">FORM PENGAJUAN SURAT KETERANGAN BELUM MENIKAH</div>
					</div>
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									...
									<textarea class="form-control" id="keperluan" name="keperluan" rows="3" placeholder="Tuliskan keperluan pembuatan surat keterangan belum menikah" required></textarea>
								</div>
							</div>
						</div>
					</div>
...
if (isset($_POST['kirim'])) {
	...
	$sql = "INSERT INTO data_request_skbm (
				no_kk,
				nama_kk,
                nik,
                Nama, 
