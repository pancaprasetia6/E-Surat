...
if (isset($_GET['id_request_sktm'])) {
    ...
    $sql = "SELECT * FROM data_request_sktm WHERE id_request_sktm='$id'";
    ...
    $qrCodePath = generateQRCode($signature, $id, 'sktm');
    
    // Simpan signature ke database
    $data_json = json_encode($data_to_sign);
    $cek_db = mysqli_query($konek, "SELECT * FROM digital_signature_log WHERE id_request='$id' AND jenis_surat='sktm'");
    if(mysqli_num_rows($cek_db) == 0) {
        mysqli_query($konek, "INSERT INTO digital_signature_log (id_request, jenis_surat, data_json, signature) VALUES ('$id', 'sktm', '$data_json', '$signature')");
    }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar warga kami yang tinggal dilingkungan RT 003, RW 006, Kelurahan Ciganjur, Kecamatan Jagakarsa, Kota Administrasi Jakarta Selatan, dan benar benar berasal dari keluarga kurang mampu.</p>
